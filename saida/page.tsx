    ...
    <>
      ...
      >
        ...
        <section id="o-que-e" className="mb-12 scroll-mt-20">
          ...
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">O bebedouro inox 3 torneiras é um equipamento industrial com reservatório de até 100 litros, estrutura em aço inoxidável e três saídas simultâneas de água — gelada, natural e filtrada. Pertence à família dos <a href="/bebedouro-inox" className="text-az hover:underline">bebedouro inox</a>, sendo o modelo mais indicado para ambientes com alto fluxo de pessoas que exigem atendimento sem filas e conformidade com INMETRO e NBR 13713.</p>
        </section>
        ...
        <section id="especificacoes-tecnicas" className="mb-12 scroll-mt-20">
          ...
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">Cada torneira opera de forma independente. Em modelos padrão, duas torneiras fornecem água gelada e uma fornece água natural sem refrigeração. Algumas configurações permitem personalizar essa divisão conforme a necessidade específica do local de instalação.</p>
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">O aparador de água frontal em chapa de aço inox com dreno integrado evita acúmulo de líquido no piso e facilita a limpeza diária. A conexão hidráulica é feita por entrada padrão de ½ polegada, compatível com a maioria das redes de abastecimento municipais em todo o Brasil.</p>
        </section>
        ...
        <section id="onde-encontrar" className="mb-12 scroll-mt-20">
          ...
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">Na hora da compra, solicite nota fiscal com descrição completa do equipamento, número de série e certificado de garantia. Esses documentos são necessários para acionamento da assistência técnica e para comprovação junto à vigilância sanitária em inspeções do ambiente de trabalho. Mantenha registros de todas as higienizações e trocas de filtro para embasar eventuais auditorias internas.</p>
        </section>
