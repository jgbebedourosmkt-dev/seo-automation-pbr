...
const faqs = [
  {
    question: 'Qual é a capacidade do bebedouro inox 3 torneiras?',
    answer: 'Os modelos mais comuns de bebedouro inox 3 torneiras possuem reservatório de 100 litros, suficiente para atender ambientes com alto fluxo de usuários ao longo de toda a jornada de trabalho sem interrupções.',
  },
  {
    question: 'O bebedouro inox 3 torneiras tem certificação INMETRO?',
    answer: 'Sim. Os bebedouros inox 3 torneiras de fabricantes homologados possuem certificação INMETRO, em conformidade com a NBR 13713, garantindo segurança elétrica, higiene e eficiência energética exigidas pela legislação brasileira.',
  },
  {
    question: 'Qual a diferença entre o bebedouro inox 2 torneiras e o de 3 torneiras?',
    answer: 'O modelo de 3 torneiras permite atendimento simultâneo de três usuários e normalmente oferece saída de água gelada, natural e filtrada. Já o modelo de 2 torneiras é indicado para ambientes com fluxo moderado e ocupa menos espaço físico.',
  },
  {
    question: 'O bebedouro inox 3 torneiras pode ser instalado em fábricas e obras?',
    answer: 'Sim. O bebedouro inox 3 torneiras é exatamente o equipamento indicado pela NR-24 para locais de trabalho com grande número de colaboradores. Sua estrutura em aço inoxidável resiste à umidade, poeira e uso intenso típicos de ambientes industriais.',
  },
  {
    question: 'Qual voltagem está disponível para o bebedouro inox 3 torneiras?',
    answer: 'A maioria dos modelos está disponível nas versões 110V e 220V. É fundamental verificar a tensão da rede elétrica do local de instalação antes da compra para evitar riscos elétricos e danos ao equipamento.',
  },
  {
    question: 'Com que frequência higienizar o bebedouro inox 3 torneiras?',
    answer: 'Recomenda-se higienização quinzenal em locais de alto fluxo e mensal em ambientes com menor uso. A RDC 275 da ANVISA orienta os procedimentos sanitários aplicáveis a equipamentos de água de uso coletivo, incluindo limpeza do reservatório e troca periódica do filtro.',
  },
]
  ...
  return (
    <>
      ...
      <PilarLayout
        badge="Guia Completo"
        title="Bebedouro Inox 3 Torneiras: Modelos e Especificações"
        excerpt="O bebedouro inox 3 torneiras é a solução industrial para ambientes com alto fluxo de usuários que precisam de atendimento simultâneo e estrutura em aço inoxidável certificada."
      ...
      >
        ...
        <section id="o-que-e" className="mb-12 scroll-mt-20">
          ...
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">O <strong>bebedouro inox 3 torneiras</strong> é um equipamento industrial com reservatório de até 100 litros, estrutura em aço inoxidável e três saídas simultâneas de água — gelada, natural e filtrada. É indicado para ambientes com alto fluxo de pessoas que não podem tolerar filas ou falta de hidratação.</p>
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">Dentro da família dos <a href="/bebedouro-inox" className="text-az hover:underline">bebedouro inox</a>, o modelo com 3 torneiras representa o equilíbrio mais eficiente entre capacidade de atendimento e custo operacional. É fabricado por marcas como Robust, Acqua Gelata, Lider e Frisbel, disponível em 110V ou 220V.</p>
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">A configuração mais comum prevê duas saídas de água gelada e uma de água natural. Esse arranjo reduz o consumo de energia sem comprometer a experiência dos usuários em ambientes com demanda variada ao longo do dia.</p>
        </section>
        ...
        <section id="especificacoes-tecnicas" className="mb-12 scroll-mt-20">
          ...
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">Os modelos mais comercializados de bebedouro inox 3 torneiras possuem reservatório de 100 litros, com dimensões aproximadas de 55 cm de largura, 47 cm de profundidade e 120 cm de altura. O peso varia entre 35 e 50 kg conforme o fabricante e os componentes utilizados.</p>
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">A potência elétrica fica entre 370W e 500W, com tensão de 110V ou 220V. A temperatura de saída da água gelada é de 4°C a 10°C, adequada para ambientes industriais mesmo em dias de calor intenso. O compressor é hermético e vedado de fábrica, com gás R134a ou R600a nos modelos mais recentes.</p>
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">Cada torneira opera de forma independente. Em modelos padrão, duas torneiras fornecem água gelada e uma fornece água natural sem refrigeração. Algumas configurações permitem personalizar essa divisão conforme a necessidade do local.</p>
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">O aparador de água frontal em chapa de aço inox com dreno integrado evita acúmulo de líquido no piso e facilita a limpeza diária. A conexão hidráulica é feita por entrada padrão de ½ polegada, compatível com a maioria das redes de abastecimento municipais.</p>
        </section>

        {/* Seção 3: Modelos Disponíveis — imagem 1 */}
        <section id="modelos-disponiveis" className="mb-12 scroll-mt-20">
          ...
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">
            ...
            O mercado brasileiro oferece diversas linhas de bebedouro inox 3 torneiras. A linha Robust é uma das mais vendidas: estrutura em inox escovado 430, tampa em inox 304 e torneiras em plástico de alto impacto. O modelo de 100 litros pesa cerca de 43 kg e suporta uso contínuo em ambientes industriais exigentes.
          </p>
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">A Acqua Gelata oferece o modelo de 100 litros em 110V com filtro externo de fácil instalação, comercializado em grandes redes varejistas. O modelo Lider (LE) possui inox escovado com torneiras em aço inoxidável, sendo preferido em ambientes sujeitos a uso intenso ou atos de vandalismo.</p>
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">A Frisbel disponibiliza bebedouros de 100 litros com filtro integrado na versão 220V, aprovados pela NBR 13713 e certificados pelo INMETRO. Compressores de marcas como Embraco e Tecumseh oferecem maior vida útil e menor consumo energético, critério importante na escolha do modelo.</p>
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">Na escolha do modelo, verifique a espessura do inox da carcaça, o tipo de filtro compatível e se o produto acompanha kit de instalação. Modelos com cuba também em inox 304 oferecem maior resistência à corrosão e são recomendados para ambientes úmidos ou costeiros.</p>
          <div style={{ clear: 'both' }} />
        </section>

        {/* Seção 4: Ambientes e Uso Corporativo */}
        <section id="ambientes-e-uso-corporativo" className="mb-12 scroll-mt-20">
          <h2 className="text-[30px] font-black text-txt mb-4 pb-2 border-b-2 border-borda" style={{ fontFamily: 'var(--font-barlow-condensed)' }}>Ambientes Indicados e Uso Corporativo</h2>
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">O bebedouro inox 3 torneiras atende diretamente à NR-24, que determina a obrigatoriedade de fornecimento de água potável fresca para trabalhadores. Em ambientes com 30 a 80 funcionários por turno, esse modelo costuma ser suficiente para garantir acesso à hidratação sem formação de filas nos intervalos.</p>
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">Fábricas, galpões logísticos, academias, refeitórios e escolas são os principais usuários desse equipamento. Em restaurantes e lanchonetes, a torneira de água natural facilita o autoatendimento dos colaboradores sem consumir energia de refrigeração desnecessária durante o turno.</p>
          ...
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">Em hospitais, clínicas e unidades de saúde, a estrutura em aço inox facilita a higienização e atende à RDC 275 da ANVISA, norma sanitária que regula a qualidade da água em estabelecimentos de saúde. O reservatório fechado do bebedouro evita contaminação por agentes externos presentes no ambiente.</p>
        </section>

        {/* Seção 5: Certificações e Normas */}
        <section id="certificacoes-e-normas" className="mb-12 scroll-mt-20">
          <h2 className="text-[30px] font-black text-txt mb-4 pb-2 border-b-2 border-borda" style={{ fontFamily: 'var(--font-barlow-condensed)' }}>Certificações e Normas Aplicáveis</h2>
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">Ao adquirir um bebedouro inox 3 torneiras, exija o certificado do INMETRO. A certificação garante que o produto foi testado conforme os critérios de segurança elétrica, eficiência energética e qualidade construtiva do Instituto Nacional de Metrologia. Equipamentos sem certificação podem ser autuados em fiscalizações trabalhistas e sanitárias.</p>
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">A <strong>NBR 13713</strong> é a norma técnica que define os requisitos mínimos de desempenho para bebedouros elétricos no Brasil, incluindo temperatura da água gelada, nível de ruído, isolamento elétrico e materiais em contato com água potável. Todos os modelos destinados à venda devem estar em plena conformidade com essa norma.</p>
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">A <strong>NR-24</strong> do Ministério do Trabalho determina que empresas com mais de 25 colaboradores disponibilizem água potável fresca em quantidade suficiente. O bebedouro inox 3 torneiras atende diretamente esse requisito em linhas de produção e obras, onde a hidratação é condição obrigatória de segurança do trabalho.</p>
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">Para estabelecimentos que manipulam alimentos, a <strong>RDC 275</strong> da ANVISA exige equipamentos higienizáveis em contato com água de consumo humano. O inox escovado atende a essa exigência: não absorve odores ou sabores, resiste a produtos de limpeza industriais e pode ser sanitizado com hipoclorito sem corrosão da superfície.</p>
        </section>

        {/* Seção 6: Manutenção e Higiene */}
        <section id="manutencao-e-higiene" className="mb-12 scroll-mt-20">
          ...
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">Recomenda-se afixar próximo ao bebedouro uma planilha de controle de higienização com data, responsável e produto utilizado. Esse registro facilita auditorias internas e inspeções da vigilância sanitária, demonstrando conformidade com a RDC 275 e os procedimentos internos de segurança alimentar da empresa.</p>
        </section>

        {/* Seção 7: Modelos Relacionados — imagem 2 */}
        <section id="modelos-relacionados" className="mb-12 scroll-mt-20">
          ...
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">
            ...
            Para ambientes com menor fluxo, o <a href="/bebedouro-inox-2-torneiras" className="text-az hover:underline">bebedouro inox 2 torneiras</a> é indicado para locais com até 30 usuários por turno, com menor consumo elétrico e preço de aquisição mais acessível. É uma boa opção como ponto de hidratação secundário em setores administrativos.
          </p>
          ...
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">Para locais com espaço limitado no piso, o <a href="/bebedouro-inox-25-litros" className="text-az hover:underline">bebedouro inox 25 litros</a> de bancada é uma alternativa compacta para halls de atendimento ou cozinhas onde instalar um modelo de chão não é estruturalmente viável. Seu consumo elétrico é significativamente menor.</p>
          <div style={{ clear: 'both' }} />
        </section>

        {/* Seção 8: Como Escolher */}
        <section id="como-escolher" className="mb-12 scroll-mt-20">
          ...
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">O primeiro critério na escolha é o número de usuários simultâneos. A regra geral é de 1 torneira para cada 40 a 50 colaboradores em uso simultâneo. Com três torneiras, o modelo atende bem ambientes de 80 a 150 pessoas por turno, dependendo do regime de trabalho e dos horários de pico de consumo.</p>
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">Verifique a infraestrutura do local: é necessário ponto de água fria e tomada na voltagem correta (110V ou 220V) próximos ao local de instalação. O equipamento precisa de ventilação adequada ao redor do compressor — evite instalação em cantos fechados ou locais com temperatura acima de 40°C, pois isso reduz a vida útil do motor.</p>
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">Avalie se o modelo inclui filtro. Em regiões com água de baixa qualidade ou alto teor de cloro, um bebedouro com filtro embutido garante melhor sabor e segurança. Alguns fabricantes oferecem filtros com vida útil de 6 meses, enquanto outros requerem troca mensal — fator importante no custo anual de manutenção.</p>
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">Para referências de custo atualizadas e comparativo entre marcas disponíveis, <a href="/blog/bebedouro-industrial-preco-2025" className="text-az hover:underline">veja a faixa de preço</a> dos principais modelos do mercado. Avalie também a garantia: modelos com garantia de 12 meses no compressor e 6 meses nas peças são mais confiáveis para uso contínuo industrial.</p>
        </section>
