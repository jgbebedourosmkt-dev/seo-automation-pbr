    ...
    <>
      ...
      >
        ...
        <section id="onde-encontrar" className="mb-12 scroll-mt-20">
          ...
          <p className="mb-4 text-[16px] text-txt2 leading-relaxed">Na hora da compra, solicite nota fiscal com descrição completa do equipamento, número de série e certificado de garantia. Esses documentos são necessários em caso de acionamento da assistência técnica e para comprovação junto à vigilância sanitária durante eventuais inspeções do ambiente de trabalho. O técnico de segurança do trabalho deve orientar os colaboradores sobre o uso correto e a importância da higienização periódica do bebedouro inox 3 torneiras.</p>
        </section>
